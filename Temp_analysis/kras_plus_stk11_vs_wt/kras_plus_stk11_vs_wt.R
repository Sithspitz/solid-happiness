...
mt_vs_wt_data <- read.csv("kras_plus_stk11_vs_wt.csv")

# Subsetting dependent on if WT or MT
s_wt <- mt_vs_wt_data[mt_vs_wt_data$mutation == "WT", ]
s_mt <- mt_vs_wt_data[mt_vs_wt_data$mutation == "KRAS/STK11 MT", ]
...
mt_vs_wt_data$mutation <- factor(mt_vs_wt_data$mutation, levels = 
                                   c("WT", "KRAS/STK11 MT"))
my_comparisons <- list(c("WT", "KRAS/STK11 MT"))
